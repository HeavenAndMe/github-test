                    ...
                    <c:if test="${baseResult != null}">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                <a href="#" type="button" class="btn btn-sm btn-default"><i class="fa fa-download"></i> 导人</a>&nbsp;&nbsp;&nbsp;
                            ...
                            <div class="box-body table-responsive">
                                <table id="dataTable" class="table table-hover">
                                    <thead>
                                    <tr>
                                        <th><input type="checkbox" class="minimal checkbox_master" /></th>
                                        <th>ID</th>
                                        <th>用户名</th>
                                        <th>手机号</th>
                                        <th>邮箱</th>
        ...
        var _columns = [
            ...
            },
            {
                "data": function ( row, type, val, meta ) {
                    ...
                    return '<a type="button" class="btn btn-sm btn-default" onclick="App.showDetail(\''+detailUrl+'\');"><i class="fa fa-search"></i> 查看</a>&nbsp;&nbsp;&nbsp;' +
                        '<a href="/user/form?id='+row.id+'" type="button" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> 编辑</a>&nbsp;&nbsp;&nbsp;' +
                        '<a type="button" class="btn btn-sm btn-danger" onclick="App.deleteSingle(\''+ deleteUrl + '\',\'' + row.id +'\')"><i class="fa fa-trash-o"></i> 删除</a>';
                }
            }
        ];
