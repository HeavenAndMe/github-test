                        ...
                        <form:form id="inputForm" cssClass="form-horizontal" action="/user/save" method="post" modelAttribute="tbUser">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input cssClass="form-control email required" path="email" placeholder="请输入邮箱地址"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input cssClass="form-control required -mobile" path="phone" placeholder="请输入用户手机号"/>
                                    </div>
                                </div>
                            </div>
