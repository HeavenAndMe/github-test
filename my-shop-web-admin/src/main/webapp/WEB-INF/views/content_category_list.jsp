                    ...
                    <div class="box">
                        ...
                        <div class="box-body table-responsive">
                            <table id="treeTable" class="table table-hover">
                                ...
                                <tbody>
                                    <c:forEach items="${tbContentCategorys}" var="tbContentCategory">
                                        <tr id="${tbContentCategory.id}" pId="${tbContentCategory.parent.id}">
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-sm btn-danger" onclick="App.deleteSingle('/content/category/delete', '${tbContentCategory.id}', '警告：该操作会将包括选中类目在内的全部子类目及类目的内容一并删除，请谨慎操作！您确定要继续吗？')"><i class="fa fa-trash-o"></i> 删除</button>
