            ...
            <div class="kengl_kuang">
                ...
                <form action="/login" method="post">
                    <div class="txt_kuang">
                        ...
                        <input id="verification" name="verification" type="text" class="itxt" placeholder="验证码" style="width: 109px;">
                        <img id="validateCode" src="/verification" style="float: right; padding-right: 34px; cursor: pointer;" title="看不清？换一张" />
                    </div>
                    <div class="remember">
                        <div class="fl">
                            <input type="checkbox" >
